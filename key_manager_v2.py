...
def _test_openai_compat(key, model_id, endpoint_url):
    ...
    # Reasoning models (o-series like o3-mini, o4-mini, and the gpt-5 family) require
    # max_completion_tokens; legacy chat-completion models still use max_tokens.
    # This split exists because OpenAI rejects the wrong parameter name with HTTP 400,
    # so we'd see false-negative "key invalid" errors without this branch.
